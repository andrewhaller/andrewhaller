...
[![Continuous integration](https://github.com/stairwaytowonderland/andrewhaller/actions/workflows/ci.yaml/badge.svg)](https://github.com/stairwaytowonderland/andrewhaller/actions/workflows/ci.yaml)
[![GitHub latest release](https://img.shields.io/github/v/release/stairwaytowonderland/andrewhaller?include_prereleases&logo=rocket)](https://github.com/stairwaytowonderland/stairwaytowonderland/andrewhaller/releases)
[![GitHub last commit](https://img.shields.io/github/last-commit/stairwaytowonderland/andrewhaller?logo=git)](https://github.com/stairwaytowonderland/stairwaytowonderland/andrewhaller/commits/main)
[![GitHub license](https://img.shields.io/github/license/stairwaytowonderland/andrewhaller?logo=opensourceinitiative&labelCol&color=yellow&logoColor=white)](https://github.com/stairwaytowonderland/stairwaytowonderland/andrewhaller/tree/main/LICENSE)
...
- [x] **:one: :clipboard: Create your repo:** Use this template to [**Create your own project**](#clipboard-create-your-own-project)!
- [x] **:two: :label: Create some labels:** Run the [Create Labels](https://github.com/stairwaytowonderland/andrewhaller/actions/workflows/create-labels.yaml)
_workflow_ to create some additional useful labels.
- [ ] **:three: :bookmark: Create some issues:** Run the [Import Issues from CSV](https://github.com/stairwaytowonderland/andrewhaller/actions/workflows/import-csv-issues.yaml)
...
workflow failures.
_(See [Development Guidelines](https://github.com/stairwaytowonderland/andrewhaller?tab=contributing-ov-file#development-guidelines) for details)_
...
> [!NOTE]
>
> See [Contributing Guidelines](https://github.com/stairwaytowonderland/andrewhaller?tab=contributing-ov-file#contributing-guidelines)
